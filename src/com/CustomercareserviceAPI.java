...
import com.Customercareservice;
 ...
 */
@WebServlet("/CustomercareserviceAPI")
public class CustomercareserviceAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String output = projectObj.insertProject(request.getParameter("customerId"), 
				request.getParameter("bilAccount"),
