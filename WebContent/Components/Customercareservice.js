...
$(document).on("click", "#btnSave", function(event) {
	...
	$.ajax({
		url : "CustomercareserviceAPI",
		type : type,
		data : $("#formCustomercareservice").serialize(),
		dataType : "text",
...
function onProjectSaveComplete(response, status) {
	...
	$("#formCustomercareservice")[0].reset();
}
...
$(document).on(
		...
		function(event) {
			...
			$("#bilAccount").val($(this).closest("tr").find('td:eq(1)').text());
...
function validateProjectForm() {
	 ...
	 if ($("#customerId").val().trim() == "") {
			return "Insert Customer IDInsert Customer ID";
		}
	 
	
	if ($("#bilAccount").val().trim() == "") {
